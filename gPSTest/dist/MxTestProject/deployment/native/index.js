...
import { navigationStyle } from "E:/workspace/src/mendix/GPSTest-Native/mendix-GPSTest/gPSTest/dist/MxTestProject/theme/styles.js";
...
startApp({
    ...
    "onStartupNativeClient": () => {
        NativeUI.registerPage("NativeMobile.Home_Native", require("E:/workspace/src/mendix/GPSTest-Native/mendix-GPSTest/gPSTest/dist/MxTestProject/deployment/native/pages/NativeMobile.Home_Native"), {"sidebar":false,"headerRegionName":"placeholder$Header","showBottomBar":true,"type":"Default"});
        NativeUI.registerPage("NativeMobile.Login", require("E:/workspace/src/mendix/GPSTest-Native/mendix-GPSTest/gPSTest/dist/MxTestProject/deployment/native/pages/NativeMobile.Login"), {"sidebar":false,"headerRegionName":"placeholder$Header","showBottomBar":true,"type":"Default"});
    }
});